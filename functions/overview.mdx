...
<table>
<tr><th>Ordinary language function</th><th>Dagger Function</th></tr>
<tr><td>Runs in the host process</td><td>Runs in an isolated container</td></tr>
<tr><td>Gets plain strings & ints</td><td>Gets rich typed objects: Container, Directory, Secret, …</td></tr>
<tr><td>Language-specific</td><td>Callable from any language once it's in a Module</td></tr>
<tr><td>No built-in caching</td><td>Results are automatically cached & content-addressed</td></tr>
</table>
